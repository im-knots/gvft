...
This is a heavily work in progress and unpolished repo im working on as a fun side project based around an idea I had. It currently stands as a conjecture that translating neural archetectures from graph to field representations will preserve information related to cognative connectivity between neural "modules", and that this would allow us to use field representations to help neural architecture search. Please bear with me
