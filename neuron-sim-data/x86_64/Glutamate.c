...
#define rates rates__Glutamate 
#define states states__Glutamate 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 Glutamate /home/knots/git/gvft/neuron-sim-data/Glutamate.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "Mod file for component: Component(id=Glutamate type=expTwoSynapse)";
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/knots/git/gvft/neuron-sim-data/Glutamate.mod";
static const char* nmodl_file_text = 
